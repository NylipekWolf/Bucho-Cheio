...
import { CardapioFilter } from '../services/filters/cardapio-filter.interface';
import { FormBuilder, FormGroup } from '@angular/forms';
import { showWarningMessage } from '../../../../../../utils/message.utils';
import { Store } from '@ngrx/store';
import { AppModel } from '../../../../../../ngrx/app.models';
import { CardapioResponse } from '../services/responses/cardapio-response.interface';
...
export class CardapioComponent implements OnInit, OnDestroy {
  ...
  private search(filter?: CardapioFilter, moreItems?: boolean) {
    this.loading = true;
    this._service
      .search(filter)
      .pipe(takeUntil(this._unsub$))
      .subscribe({
        next: (res: CardapioResponse[]) => {
